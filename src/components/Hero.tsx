      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto space-y-6">
          ...
          <motion.div
            ...
            className="inline-flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 px-4 py-2 rounded-full dark:bg-[#0f172a]/90 bg-white/90 border dark:border-[#131126] border-[#c7c4d8]/35 text-xs shadow-xl backdrop-blur-md hover:border-[#3525cd]/40 transition-all"
          >
          ...
          <motion.h1
            ...
            className="text-4xl sm:text-5xl lg:text-6xl font-black dark:text-white text-slate-950 tracking-tight leading-[1.2] sm:leading-[1.18] max-w-4xl mx-auto"
          >
            Autonomous Onboarding,{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3525cd] via-[#4f46e5] to-[#10b981] inline-block">
              Scope Lockdown
            </span>{' '}
            & Legal Shield for Web Designers & Developers
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl dark:text-slate-300 text-slate-700 max-w-3xl mx-auto font-normal leading-relaxed pt-2"
          >
            Protect your freelance web design and custom development projects against <strong className="dark:text-white text-slate-950 font-bold">Scope Creep</strong> and unpaid page additions. Freeze website briefings, require <strong className="dark:text-white text-slate-950 font-bold">Master Keys</strong> for scope changes, and lock client approvals with <strong className="dark:text-white text-slate-950 font-bold">SHA-256 Cryptographic Hashes</strong>.
          </motion.p>
          ...
          >
            ...
            <a
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-3 text-base font-extrabold dark:text-white text-slate-900 px-8 py-4 sm:py-5 rounded-2xl dark:bg-[#0f172a] bg-white hover:bg-slate-100 dark:hover:bg-[#1a233a] border dark:border-[#3525cd]/40 border-[#3525cd]/30 shadow-lg hover:shadow-xl transition-all duration-200 cursor-pointer group"
            >
              <div className="w-8 h-8 rounded-xl bg-[#3525cd]/20 flex items-center justify-center text-[#4f46e5] shrink-0 group-hover:scale-110 transition-transform">
          ...
          <motion.div
            ...
            className="pt-2 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs font-semibold text-slate-500 dark:text-slate-400"
          >
          ...
          <div className="pt-8 grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
            <motion.div
              ...
              className="p-4 rounded-2xl dark:bg-[#0f172a]/80 bg-white/80 border dark:border-[#131126] border-[#c7c4d8]/35 backdrop-blur-sm text-center shadow-sm hover:border-[#3525cd]/40 transition-all"
            >
