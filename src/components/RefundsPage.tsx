...
import { CreditCard, ShieldCheck, CheckCircle2, Mail, ExternalLink, ArrowLeft, Copy, Check, RefreshCw } from 'lucide-react';
...
export const RefundsPage: React.FC<RefundsPageProps> = ({ onNavigate, onOpenTrial, onOpenChangelog }) => {
  ...
  const handleCopyPaddleText = () => {
    navigator.clipboard.writeText("What will you sell on Paddle?");
    setCopied(true);
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="space-y-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#3525cd]/10 text-[#4f46e5] border border-[#3525cd]/30 text-xs font-mono font-bold uppercase tracking-widest">
              ...
              <span>Paddle Merchant Refund & Cancellation Policy</span>
            </div>
            ...
            <p className="text-base sm:text-lg dark:text-slate-300 text-slate-700 max-w-3xl leading-relaxed">
              Complete transparency regarding SaaS subscription refunds, billing cancellations, and Paddle Merchant of Record rules.
            </p>
          </div>
          ...
          <div className="p-6 sm:p-10 rounded-3xl dark:bg-[#0b101d] bg-white border dark:border-[#1e293b] border-slate-200 shadow-xl space-y-10 text-sm leading-relaxed dark:text-slate-300 text-slate-700">
            ...
            <section className="space-y-4">
              <h2 className="text-xl font-extrabold dark:text-white text-slate-900 flex items-center gap-2 tracking-tight">
                ...
                Paddle Merchant of Record (SaaS Transactions)
              </h2>
              <p>
                All digital transactions and SaaS subscription payments for <strong>Velloxis</strong> are processed through <strong>Paddle.com Market Limited ("Paddle")</strong>, our authorized Merchant of Record. Paddle is responsible for secure checkout handling, tax compliance, invoicing, and refund processing.
              </p>
            </section>
              ...
              <div className="p-6 rounded-3xl dark:bg-[#091512] bg-emerald-50/80 border border-[#10b981]/40 space-y-4 shadow-lg">
                ...
                <ul className="space-y-3 pt-2 text-sm">
                  <li className="flex items-start gap-2.5">
                    ...
                    <span>
                      <strong className="dark:text-white text-slate-900">Subscription Cancellation:</strong> You may cancel your SaaS subscription at any time via your account settings or through the billing link in your Paddle email receipts.
                    </span>
                  </li>
                  <li className="flex items-start gap-2.5">
                    <span className="text-[#10b981] font-bold shrink-0">•</span>
            ...
            {/* Vendor Copy Helper */}
            <section className="space-y-4">
              <div className="p-5 rounded-2xl dark:bg-[#0d1322] bg-slate-100 border dark:border-[#1e293b] border-slate-300 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="space-y-1">
                  <span className="text-xs font-mono uppercase text-[#818cf8] font-bold block tracking-wider">
                    PADDLE VENDOR ONBOARDING FIELD COPY HELPERS:
                  </span>
                  <p className="text-xs font-mono dark:text-slate-300 text-slate-700">
                    Copy "What will you sell on Paddle?" text
                  </p>
                </div>
                <button
                  onClick={handleCopyPaddleText}
                  className="px-4 py-2 rounded-xl dark:bg-[#0f172a] bg-white hover:bg-[#1e293b] hover:text-white dark:text-slate-200 text-slate-800 border dark:border-[#1e293b] border-slate-300 font-mono text-xs font-bold transition-all flex items-center gap-2 cursor-pointer shrink-0 shadow-sm"
                >
            ...
            <section className="space-y-4 border-t dark:border-[#1e293b] border-slate-200 pt-8">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 pt-2">
                ...
                >
                  ...
                  <span>Paddle Buyer Portal (paddle.net)</span>
                </a>
              </div>
            </section>
