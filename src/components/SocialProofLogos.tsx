...
export const SocialProofLogos: React.FC = () => {
  ...
  const ecosystemIntegrations = [
    {
      name: 'GitHub',
      role: 'Code & Repository Syncing',
      description: 'Freezes repository milestones and generates SHA-256 logs upon client approval.',
      svg: (
    ...
    {
      name: 'Figma',
      role: 'Prototype & UI/UX Import',
      description: 'Binds design tokens and interactive prototypes directly to the client sign-off sheet.',
      svg: (
    ...
    {
      name: 'Discord',
      role: 'Real-Time Webhooks & Alerts',
      description: 'Instant notifications when clients sign scope briefs or request Master Key unlocks.',
      svg: (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b dark:border-[#1e293b] border-slate-200 pb-4">
            <div className="space-y-1">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#3525cd]/15 text-[#818cf8] border border-[#3525cd]/30 text-[10px] font-mono font-bold uppercase tracking-wider">
                ...
                <span>ECOSYSTEM & NATIVE INTEGRATIONS INCLUDED</span>
              </div>
              <h3 className="text-xl sm:text-2xl font-black dark:text-white text-slate-900">
                Seamlessly Connect Velloxis to Your Tech Stack
              </h3>
            </div>
        ...
        <div className="space-y-6">
          <div className="text-center space-y-2">
            <p className="text-xs font-mono font-bold uppercase tracking-widest text-[#4f46e5]">
              TRUSTED BY LEADING SOFTWARE STUDIOS & DIGITAL AGENCIES
            </p>
            <p className="text-sm dark:text-slate-300 text-slate-600">
              Protecting millions in client deliverables daily with Velloxis Scope Lockdown
            </p>
          </div>
        ...
        <div className="pt-6 border-t dark:border-[#131126] border-[#c7c4d8]/35 flex flex-wrap items-center justify-center gap-4 text-xs font-mono">
          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl dark:bg-[#0f172a] bg-white border dark:border-[#131126] border-[#c7c4d8]/35 shadow-sm">
            ...
            <span className="dark:text-slate-300 text-slate-700 font-bold">Immutable SHA-256 Cryptographic Hashes</span>
          </div>

          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl dark:bg-[#0f172a] bg-white border dark:border-[#131126] border-[#c7c4d8]/35 shadow-sm">
            <Lock className="w-4 h-4 text-[#4f46e5]" />
            <span className="dark:text-slate-300 text-slate-700 font-bold">Device & Browser Fingerprint Locking</span>
          </div>

          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl dark:bg-[#0f172a] bg-white border dark:border-[#131126] border-[#c7c4d8]/35 shadow-sm">
            <Key className="w-4 h-4 text-[#f59e0b]" />
            <span className="dark:text-slate-300 text-slate-700 font-bold">Atomic Security Master Keys</span>
          </div>

          <div className="flex items-center gap-2 px-3.5 py-2 rounded-xl dark:bg-[#0f172a] bg-white border dark:border-[#131126] border-[#c7c4d8]/35 shadow-sm">
            <Award className="w-4 h-4 text-emerald-400" />
            <span className="dark:text-slate-300 text-slate-700 font-bold">Certified Legal Electronic Evidence Standard</span>
          </div>
        </div>
